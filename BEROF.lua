...
if text and text:match("^ضع رد تواصل ⚠️") and is_devmohmad(msg) then   mohmadDEVBEROF:setex(DEVBERO.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  berof_sendMsg(msg.chat_id_, msg.id_, 1,'☑*┇* ارسل لي النص الذي تريده ', 1, 'md') end 
