if text =='نقاطي' then 
if tonumber((berofdx1:get(berof..'bot:add:num'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
berof = '*🚦⁞ ليس لديك نقاط •\n🚦⁞ ارسل { سمايلات او الاسرع } وابدا العب لتحصل على النقاط • '
berofdx(msg.chat_id_, msg.id_, 1,berof, 1, 'md')
else
berof = '🚦⁞ لديك ('..(berofdx1:get(berof..'bot:add:num'..msg.chat_id_..msg.sender_user_id_))..') نقطه •'
berofdx(msg.chat_id_, msg.id_, 1,berof, 1, 'md')
end
end
if text == 'سمايلات' and berofdx1:get(berof..'bot:lock_geam'..msg.chat_id_) then
berofdx1:del(berof..'bot:l:ids'..msg.chat_id_)
katu = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','📌','📍','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = katu[math.random(#katu)]
berofdx1:set(berof..'bot:klmos'..msg.chat_id_,name)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
berof = '🚦⁞ اول واحد يدز هذا السمايل  {'..name..'} يربح •'
berofdx(msg.chat_id_, msg.id_, 1,berof, 1, 'md')
end
if text == ''..(berofdx1:get(berof..'bot:klmos'..msg.chat_id_) or 'لفاتع')..'' and not berofdx1:get(berof..'bot:l:ids'..msg.chat_id_) then
if not berofdx1:get(berof..'bot:l:ids'..msg.chat_id_) then 
berof = '🚦⁞ انت الرابح • \n🚦⁞ للعب مره اخرى ارسل سمايلات •'
berofdx(msg.chat_id_, msg.id_, 1,berof, 1, 'md')
berofdx1:incrby(berof..'bot:add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
end
berofdx1:set(berof..'bot:l:ids'..msg.chat_id_,true)
end
if text == 'ترتيب' and berofdx1:get(berof..'bot:lock_geam'..msg.chat_id_) then
berofdx1:del(berof..'bot:l:id'..msg.chat_id_)
...
name = katu[math.random(#katu)]
berofdx1:set(berof..'bot:klmo'..msg.chat_id_,name)
...
berof = '🚦⁞ اول واحد يرتبها  {'..name..'} يربح •'
berofdx(msg.chat_id_, msg.id_, 1,berof, 1, 'md')
end
if text == ''..(berofdx1:get(berof..'bot:klmo'..msg.chat_id_) or 'لفاتع')..'' and not berofdx1:get(berof..'bot:l:id'..msg.chat_id_) then
if not berofdx1:get(berof..'bot:l:id'..msg.chat_id_) then 
berof = '🚦⁞ انت الرابح • \n🚦⁞ للعب مره اخرى ارسل ترتيب •'
berofdx(msg.chat_id_, msg.id_, 1,berof, 1, 'md')
berofdx1:incrby(berof..'bot:add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
end
berofdx1:set(berof..'bot:l:id'..msg.chat_id_,true)
end
